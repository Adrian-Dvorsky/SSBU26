...
def initialize_models_and_params():
    ...
    param_grids = {
        ...
        "Random Forest": {"n_estimators": [50, 100],"max_depth": [5,10] ,"min_samples_split": [5], "max_features": ["sqrt"]}
    }
...
def run_experiment(dataset, models, param_grids, logger):
    ...
    experiment = Experiment(models, param_grids, 40 , logger=logger)
...
def plot_results(experiment, results, logger):
    ...
    plotter.plot_evaluation_metric_over_replications(
        ...
        'Precision per Replication and Average Precision', 'Accuracy')
